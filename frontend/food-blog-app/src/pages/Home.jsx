    ...
    return (
        <>
            <section className='home'>
                <div className='left'>
                    <h1>Food Recipe</h1>
                    <h5>Welcome to our Food Recipe collection! Discover tasty homemade dishes, from quick snacks to healthy meals. Whether you’re a beginner or a master chef, you’ll find inspiration here to try something new every day.</h5>
